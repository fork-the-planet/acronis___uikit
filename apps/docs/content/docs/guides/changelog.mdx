---
title: Changelog
description: Recent release history for @acronis-platform/shadcn-uikit.
---

# Changelog

Recent releases for `@acronis-platform/shadcn-uikit`. This project follows [Semantic Versioning](https://semver.org/) and uses [Conventional Commits](https://www.conventionalcommits.org/) to generate this changelog.
...
## [0.32.2](https://github.com/acronis/shadcn-uikit/compare/v0.32.1...v0.32.2) (2026-04-01)
