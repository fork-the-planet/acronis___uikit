  ...
  theme: {
    extend: {
      "backgroundColor": {
        ...
        "button-inverted-container-hover": "light-dark(rgb(13 77 165), rgb(18 77 161))",
        "button-inverted-container-idle": "light-dark(rgb(11 66 142), rgb(255 165 0))",
        "button-primary-container-active": "light-dark(rgb(41 49 55), rgb(41 49 55))",
        "button-primary-container-disabled": "light-dark(rgb(199 203 207), rgb(199 203 207))",
        "button-primary-container-hover": "light-dark(rgb(54 65 74), rgb(54 65 74))",
        "button-primary-container-idle": "light-dark(rgb(68 81 93), rgb(68 81 93))",
