...
// Source: @acronis-platform/design-tokens • brand: default • component: CardFilter
...
export default {
  theme: {
    extend: {
      "backgroundColor": {
        "card-filter-global-container-active": "light-dark(rgb(226 235 245), rgb(48 50 54))",
      ...
      "textColor": {
        ...
        "card-filter-clickable-value": "light-dark(rgb(23 99 207), rgb(81 157 246))",
